...
const RoleTable = (createRoleData) => {
  const [rows, setData] = useState(
    createRoleData.createRoleData.tableRowsData
  );
          ...
          <Card>
            <CardBody>
              ...
              <ReactTableBase
                ...
                columns={createRoleData.createRoleData.tableHeaderData}
                data={rows}
...
RoleTable.propTypes = {
  createRoleData: PropTypes.shape({
